...
class Board {
  ...
  updateGrid() {
    Object.keys(this.squares).forEach((key) => {
      ...
      let isLiving = this.grid[squareObj.xPos][squareObj.yPos].alive;

      if ((neighborCount === 2 || neighborCount === 3) && isLiving) {

        this.mirrorGrid[squareObj.xPos][squareObj.yPos].alive = true;
        ...
        this.mirrorGrid[squareObj.xPos][squareObj.yPos].alive = false;
